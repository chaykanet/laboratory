...
int main(void)
{
    ...
    do 
    {
        ...
        printf("4.Вывести таблицу по таблице ключей.\n");
        printf("5.Вывести таблицу ключей.\n");
        printf("6.Вывести отсортированную таблицу ключей.\n");
        printf("7.Отсортировать обычной сортировкой массив машин по цене.\n8.Отсортировать обычной сортировкой массив машин по цене по ключам.\n");
        printf("9.Отсортировать быстрой сортировкой массив машин по цене.\n10.Отсортировать ускоренной сортировкой массив машин по цене по ключам.\n");
        printf("11.Вывести измерения сортировок.\n12.Найти старые определенные иномарки с 1 владельцем в заданном диапозоне цен c тех.поддержкой без ремонтов.\n");
        printf("13.Открыть новый файл\n");
        printf("14.Записать таблицу в файл\n");
        printf("15.O программе\n0.Выход.\nОжидание ввода: \n");
        rc = scanf("%d", &move);
        ...
        switch(move)
        {
            ...
            case 4:
                printf("-------------------------------------------\n");
                printf("Вывод таблицы машиин по ключам:\n");
            ...
            case 6:
                ...
                qsort_arr(key_stcp, nmemb, sizeof(ckey_t), cmp_key_price);
                print_keys(key_stcp, key_encp);
                break;
            case 7:
                printf("-------------------------------------------\n");
            ...
            case 8:
                ...
                start = clock();
                sort_arr(key_stcp, key_encp, nmemb, sizeof(ckey_t), cmp_key_price);
                end = clock();
                
                time_key_sort = (double) (end - start) / CLOCKS_PER_SEC * 1000;
                print_arr_withkey(base_st, base_en, key_stcp, key_encp);
            ...
            case 9:
                ...
                start = clock();
                qsort_arr(base_stcp, nmemb, sizeof(car_el_t), cmp_car_price);
                end = clock();
            ...
            case 15:
                printf("-------------------------------------------\n");
                printf("Программа совершает операции над таблицей машин. Осуществляет сортировку таблицы по ключам. Дает возможность добавлять или удалять элементы таблицы.\n");
                printf("Осуществляет подсчет измерений времени ывполнения различных способов сортировки таблицы.\n");
                printf("Программа может находить старые иномарки с тех. поддержкой с 1-им предыдущим владельцем без ремонта.\n");
                printf("Программа может записывать измененную таблицу в файл.\n");
                break;
            case 13:
                free(base_st);
                free(key_st);
            ...
            case 14:
                ...
                fprint_arr_car(file, base_st, nmemb);
