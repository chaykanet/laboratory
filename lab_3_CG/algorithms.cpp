...
void Algorithms::drawPointWithClr(QPainter &p, Colors &clr, double x, double y, double rf)
{
    p.setPen(QColor(clr.r, clr.g, clr.b, rf));
    p.drawPoint(x, y);
}

void Algorithms::rendering(alg algos, QPainter &p, Colors &clr, int x1, int y1, int x2, int y2)
{
    switch (algos)
    {
    case alg::Alg_DDA:
...
void Algorithms::renderingBresenham(QPainter &p, Colors &clr, int x1, int y1, int x2, int y2)
{
    int x = x1;
    int y = y1;
...
void Algorithms::renderingBresenhamDouble(QPainter &p, Colors &clr, double x1, double y1, double x2, double y2)
{
...
void Algorithms::renderingDDA(QPainter &p, Colors &clr, int x1, int y1, int x2, int y2) 
{
    if (x1 == x2 && y1 == y2)
    {
...
void Algorithms::renderingBresenhamUnStep(QPainter &p, Colors &clr, int x1, int y1, int x2, int y2)
{
    int x = x1;
    int y = y1;
    int dx = x2 - x1;
...
void Algorithms::renderingWu(QPainter &p, Colors &clr, int x1, int y1, int x2, int y2) 
{
